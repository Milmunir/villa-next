            ...
            <div>
              ...
              <div className="grid grid-cols-5 md:grid-cols-4 gap-2 text-sm">
                {villaTiara2.map((kamar) => (
                  <div key={kamar.kode_kamar} className="text-center bg-yellow-50 p-2 border-yellow-500 border-2 rounded-lg cursor-pointer hover:border-orange-700 hover:border-4" onClick={() => handleRoomClick(kamar.kode_kamar)}>
        ...
        <div className="bg-white py-8 px-12 rounded-xl shadow-lg w-full max-w-3xl md:col-span-1">
          ...
          >
            ...
            <div className="flex justify-center items-center space-x-2">
              <button type="button" onClick={handleClear} className="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg shadow-md transition flex items-center">
